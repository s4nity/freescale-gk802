...
SRC_URI="http://repository.timesys.com/buildsources/g/gpu-viv-bin-mx6q/gpu-viv-bin-mx6q-3.0.35-4.0.0/gpu-viv-bin-mx6q-3.0.35-4.0.0.tar.gz"
RESTRICT="mirror"
...
S=${WORKDIR}/gpu-viv-bin-mx6q-3.0.35-4.0.0/hardfp
